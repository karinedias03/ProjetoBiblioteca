...
class EditorasView extends StatefulWidget {
  const EditorasView({Key key}) : super(key: key);

  @override
  _EditorasViewState createState() => _EditorasViewState();
}

class _EditorasViewState extends State<EditorasView> {
  double screenWidth;
  double screenHeight;
  int selectedIndex = 0;
  List<Project> projects = [
    Project(
        title: 'Cadastrar Editoras', imageURL: 'livro.jpg', description: ''),
    Project(title: 'Editoras Cadastradas', imageURL: '', description: ''),
  ];
