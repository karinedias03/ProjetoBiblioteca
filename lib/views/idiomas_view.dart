...
class IdiomasView extends StatefulWidget {
  const IdiomasView({Key key}) : super(key: key);

  @override
  _IdiomasViewState createState() => _IdiomasViewState();
}
...
class _IdiomasViewState extends State<IdiomasView> {
  ...
  List<Project> projects = [
    Project(title: 'Cadastrar Idiomas', imageURL: 'livro.jpg', description: ''),
    Project(title: 'Idiomas Cadastrados', imageURL: '', description: ''),
  ];
